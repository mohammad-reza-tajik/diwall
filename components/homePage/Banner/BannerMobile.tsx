...
function BannerMobile() {
    return (
        <div className={"flex justify-center md:hidden mb-10 relative w-screen h-[80dvh]"}>
            <div className={"flex flex-col justify-center items-center px-2 gap-5 z-20 bg-black/60 text-primary-foreground"}>
                <h1 className={"text-center font-dana-black text-2xl"}>
                    خانه رویایی خود را به واقعیت تبدیل کنید
                </h1>
                <p className={"text-center text-base sm:text-lg leading-10"}>
