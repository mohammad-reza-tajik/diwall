    ...
    return (
        <div className={"hidden md:grid grid-cols-6 mb-10 px-1"}>
            <div className={"flex flex-col justify-center gap-8 lg:gap-12 py-4 lg:py-8 bg-primary col-span-2 px-5"}>
                ...
                <p className={"text-justify text-white lg:leading-8 text-xs lg:text-sm xl:text-base"}>
                ...
                <Link className={"btn btn-sm lg:btn-md !text-xs lg:!text-sm btn-ghost text-white border border-white hover:border-white"} href={"/products"} aria-label="مشاهده محصولات">
                    مشاهده محصولات
                </Link>
            </div>
