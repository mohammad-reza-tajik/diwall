        ...
        <Grid container item component={"section"} my={80} gap={{xs: 50, md: 80}} xs={12}>
            ...
            <Grid container item xs={12} alignItems={"center"} bgcolor={"#fff"}>
                <Grid container item direction={"column"} xs={6} md={4} lg={2} alignItems={"center"} gap={20}
                      sx={styles.place} component={Link} href={"/products?category=child_room_poster"}>
                    <Grid component={"svg"} width={{xs: 40 , md : 70}} height={{xs: 40 , md : 70}} viewBox="0 0 512 512"
                        ...
                        />
                        <rect width="40" height="40" x="168" y="232"
                              />
                        <rect width="40" height="40" x="304" y="232"
                              />
                        <path d="M256,384a80,80,0,0,0,80-80H176A80,80,0,0,0,256,384Z"/>
                    </Grid>

                    <Typography variant={"h3"} sx={styles.title} fontFamily={"dana-bold"}>اتاق کودک</Typography>
                </Grid>
                <Grid container item direction={"column"} xs={6} md={4} lg={2} alignItems={"center"} gap={20}
                      sx={styles.place} component={Link} href={"/products?category=office_poster"}>
                    <Grid component={"svg"} width={{xs: 40 , md : 70}} height={{xs: 40 , md : 70}} xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Typography variant={"h3"} sx={styles.title} fontFamily={"dana-bold"}>اداره و دفتر</Typography>
                </Grid>
                <Grid container item direction={"column"} xs={6} md={4} lg={2} alignItems={"center"} gap={20}
                      sx={styles.place} component={Link} href={"/products?category=kitchen_poster"}>

                    <Grid component={"svg"} width={{xs: 40 , md : 70}} height={{xs: 40 , md : 70}} id="Layer_1"
			...
			h35.935c14.065,0,25.505,11.485,25.505,25.6V368.64z"/>
                    ...
                    <Typography variant={"h3"} sx={styles.title} fontFamily={"dana-bold"}>آشپزخانه</Typography>
                </Grid>
                <Grid container item direction={"column"} xs={6} md={4} lg={2} alignItems={"center"} gap={20}
                      sx={styles.place} component={Link} href={"/products?category=living_room_poster"}>
                    <Grid component={"svg"} width={{xs: 40 , md : 70}} height={{xs: 40 , md : 70}} xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 315 315">
                        <path
                    ...
                    <Typography variant={"h3"} sx={styles.title} fontFamily={"dana-bold"}>اتاق خواب</Typography>
                </Grid>
                <Grid container item direction={"column"} xs={6} md={4} lg={2} alignItems={"center"} gap={20}
                      sx={styles.place} component={Link} href={"/products?category=living_room_poster"}>
                    <Grid component={"svg"} width={{xs: 40 , md : 70}} height={{xs: 40 , md : 70}} version="1.1" id="Layer_1"
                         xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 512 512">
                        <g>
                            <g>
			...
			V155.826h166.957V256z M478.609,122.435H116.87H50.087H33.391V89.043h445.217V122.435z"/>
                    ...
                    <Typography variant={"h3"} sx={styles.title} fontFamily={"dana-bold"}>اتاق کار</Typography>
                </Grid>
                <Grid container item direction={"column"} xs={6} md={4} lg={2} alignItems={"center"} gap={20}
                      sx={styles.place} component={Link} href={"/products?category=living_room_poster"}>
                    <Grid component={"svg"} width={{xs: 40 , md : 70}} height={{xs: 40 , md : 70}} version="1.1" id="Layer_1"
			...
			C480,343.232,472.832,336.064,464,336.064z"/>
                    ...
                    <Typography variant={"h3"} sx={styles.title} fontFamily={"dana-bold"}>حال و
                        پذیرایی</Typography>
                </Grid>
            </Grid>
        </Grid>
